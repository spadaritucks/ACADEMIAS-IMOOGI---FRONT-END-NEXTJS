...
export const createUnidade = async (unidadeData: FormData): Promise<Unidade[]> => {
    try {
...
export const updateUnidade = async (id: FormDataEntryValue, unidadeData: FormData): Promise<number> => {
    try {
