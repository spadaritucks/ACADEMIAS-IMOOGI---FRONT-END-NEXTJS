                ...
                <div className="modalidades-container">
                    {modalidades.map(modalidade => (
                        <div className="modalidade">
                            <Image className="modalidade-imagem" width={400} height={400} alt="" src={`${process.env.NEXT_PUBLIC_API_URL}/storage/${modalidade.foto_modalidade.replace('uploads/', '')}`}></Image>
